...
export default function SubscriptionBanner({ settings }) {
  ...
  if (isSuspended) {
    return (
      <div className="inline-flex items-center gap-3 px-4 py-2.5 border bg-red-50 border-red-200 rounded-xl">
  ...
  if (isActive && daysLeft !== null && daysLeft > 7) {
    return (
      <div className="inline-flex items-center gap-3 px-4 py-2.5 border bg-emerald-50 border-emerald-200 rounded-xl">
        <div className="relative flex items-center justify-center w-3 h-3 shrink-0">
  ...
  return (
    <>
      <div className={`inline-flex items-center justify-between px-4 py-2.5 border ${bgColor} rounded-xl`}>
