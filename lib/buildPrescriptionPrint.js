...
export function buildPrintHtml(template, tpl, prescription, items) {
  ...
  const followUpBlock = `
    <div style="margin-top:24px;border-top:1px solid #e2e8f0;padding-top:14px;display:flex;align-items:center;gap:12px">
      <span style="font-size:11px;font-weight:700;color:#64748b;text-transform:uppercase;letter-spacing:.05em;white-space:nowrap">Next Visit / Follow-up:</span>
      ${followUp
        ? `<span style="font-size:14px;font-weight:800;color:#059669">${followUp}</span>`
        : `<span style="display:inline-block;width:180px;border-bottom:1px solid #94a3b8;">&nbsp;</span>`
      }
    </div>`
  ...
  const singleColBody = `
    <div style="padding-top:4px">
      ...
      <div style="margin-top:20px;border-top:1px solid #e2e8f0;padding-top:12px;display:flex;align-items:center;gap:12px">
        <span style="font-size:11px;font-weight:700;color:#64748b;text-transform:uppercase;letter-spacing:.05em;white-space:nowrap">Next Visit / Follow-up:</span>
        ${followUp
          ? `<span style="font-size:14px;font-weight:800;color:#059669">${followUp}</span>`
          : `<span style="display:inline-block;width:180px;border-bottom:1px solid #94a3b8;">&nbsp;</span>`
